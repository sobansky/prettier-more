...
export function getParserFromLanguageId(languages: PrettierSupportLanguage[], uri: Uri, languageId: string): PrettierBuiltInParserName | string | undefined {
	...
	const language = languages.find(lang => lang && lang.extensions && Array.isArray(lang.vscodeLanguageIds) && lang.vscodeLanguageIds.includes(languageId));
